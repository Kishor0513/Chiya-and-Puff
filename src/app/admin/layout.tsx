    ...
    return (
        <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--background)' }}>
            ...
            <div style={{
                ...
                <button onClick={() => setSidebarOpen(!sidebarOpen)} style={{ background: 'none', border: 'none', color: 'var(--text-main)' }}>
                    <Menu size={24} />
                </button>
            </div>
            ...
            <aside style={{
                ...
                <div style={{ padding: '2rem 1.5rem', borderBottom: '1px solid var(--border-color)' }}>
                    <h2 style={{ margin: 0, fontSize: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        <span style={{ color: 'var(--primary)' }}><UtensilsCrossed size={24} /></span>
                        Admin Panel
                    </h2>
                </div>
        ...
        @media (max-width: 768px) {
          ...
          main { marginLeft: 0 !important; padding: 1rem !important; }
        }
      `}</style>
        </div>
    );
